    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="col-sm-6">
                ...
                <li class="breadcrumb-item active">Thêm kết quả</li>
                </ol>
            </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        ?>
            <form action="/Result/store" method="POST">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Nhập kết quả</h3>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select required id="maMH" name="maMH" class="form-control custom-select">
                                            <option disabled selected>Select one</option>
                                            <?php foreach($data['subjects'] as $key => $subject): ?>
                                                <option value="<?php echo $subject['maMH'] ?>"><?php echo $subject['maMH'] ?></option>;
                                            <?php endforeach ?>
                                        </select>
                                    </div>
                                    <div class="form-group">
