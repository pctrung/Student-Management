     ...
     <!-- Small boxes (Stat box) -->
        ...
        <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
                ...
                <a href="/Student" class="small-box-footer">Chi tiết <i class="fas fa-arrow-circle-right"></i></a>
            </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
                ...
                <a href="/Teacher" class="small-box-footer">Chi tiết <i class="fas fa-arrow-circle-right"></i></a>
            </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
                ...
                <a href="/Classroom" class="small-box-footer">Chi tiết <i class="fas fa-arrow-circle-right"></i></a>
            </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
                ...
                <a href="/College" class="small-box-footer">Chi tiết <i class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
        </div>
