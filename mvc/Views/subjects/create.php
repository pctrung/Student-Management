                            ...
                            <div class="card-header">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="soTinChi" id="soTinChi" class="form-control" >
                                    </div>
                                    <div class="form-group">
                                        <label for="soTietLT">Số tiết lý thuyết</label>
                                        <input type="number" name="soTietLT" id="soTietLT" class="form-control" >
                                    </div>
                                    <div class="form-group">
                                        <label for="soTietTH">Số tiết thực hành</label>
                                        <input type="number" name="soTietTH" id="soTietTH" class="form-control" >
                                    </div>
                                    <div class="form-group">
